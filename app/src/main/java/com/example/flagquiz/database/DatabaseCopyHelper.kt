...
class DatabaseCopyHelper(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, 1) {
    ...
    var DB_PATH: String = context.applicationInfo.dataDir + "/databases/"
    ...
    private fun checkDataBase(): Boolean {
        ...
        try {
            ...
            Log.e("DatabaseCopyHelper", "Database doesn't exist yet.")
        }
        checkDB?.close()
        return checkDB != null
    }
    ...
    private fun copyDataBase() {
        ...
        myOutput.close()
        myInput.close()
        Log.d("DatabaseCopyHelper", "Database copied successfully")
    }
    ...
    fun createDataBase() {
        ...
        if (dbExist) {
            Log.d("DatabaseCopyHelper", "Database already exists")
        } else {
    ...
    fun openDataBase() {
        ...
        Log.d("DatabaseCopyHelper", "Database opened successfully")
    }
